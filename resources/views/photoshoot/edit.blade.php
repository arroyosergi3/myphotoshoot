<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('photoshoot.update', $ps) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="mb-4">
        ...
        <textarea id="description"
                  ...
                  name="description">{{ old('description', $ps->description) }}</textarea>
